...
## Ejecución local y errores comunes

Después de descargar un ZIP nuevo, ejecuta siempre:
...
Para correr toda la batería smoke:
...
Si aparece `Cannot find module 'xlsx'`, falta ejecutar `yarn install`.

Si aparece `EADDRINUSE: address already in use :::3000`, el puerto 3000 ya está ocupado. En PowerShell:
...
También puedes usar otro puerto:
...
```txt
docs/local/LOCAL_RUN_TROUBLESHOOTING.md
```
