const DividendoService = require("../service/dividendo.service");
...
const logger = rootLogger.child({ module: "dividendo.controller" });
const MODULE_BASE_NAME = "Dividendo.controller";
const ID_PARAM_NAMES = ['id_dividendo'];
...
async function create(req, res) {
  ...
  const action = "dividendo_creation";
  const moduleName = `${MODULE_BASE_NAME}.create`;

  try {
    sendAttemptingRequest(req, logger, action, req.body);

    const result = await DividendoService.create(req.body, getAuthUserId(req));
...
async function update(req, res) {
  ...
  try {
    ...
    const result = await DividendoService.update(
      idOrParams,
      req.body,
      getAuthUserId(req)
    );
...
async function get(req, res) {
  ...
  try {
    ...
    const result = await DividendoService.get(idOrParams);
