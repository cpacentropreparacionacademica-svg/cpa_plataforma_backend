...
export class DeudaController {
  ...
  validateBatchImport(
    ...
    return this.crud.validateImportBatch('deuda', resourcePath, { body, files });
  }
  ...
  processBatchImport(
    ...
    return this.crud.processImportBatch('deuda', resourcePath, { body, files }, request.user?.idPersona);
  }
