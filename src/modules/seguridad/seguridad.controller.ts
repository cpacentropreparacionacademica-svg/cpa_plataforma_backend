...
export class SeguridadController {
  ...
  validateBatchImport(
    ...
    return this.crud.validateImportBatch('seguridad', resourcePath, { body, files });
  }
  ...
  processBatchImport(
    ...
    return this.crud.processImportBatch('seguridad', resourcePath, { body, files }, request.user?.idPersona);
  }
  ...
  createBatch(
    ...
    return this.crud.createBatch('seguridad', resourcePath, body, request.user?.idPersona);
  }
  ...
  updateBatch(
    ...
    return this.crud.updateBatch('seguridad', resourcePath, body, request.user?.idPersona);
  }
