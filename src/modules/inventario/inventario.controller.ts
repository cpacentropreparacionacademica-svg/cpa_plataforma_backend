...
export class InventarioController {
  ...
  validateBatchImport(
    ...
    return this.crud.validateImportBatch('inventario', resourcePath, { body, files });
  }
  ...
  processBatchImport(
    ...
    return this.crud.processImportBatch('inventario', resourcePath, { body, files }, request.user?.idPersona);
  }
  ...
  createBatch(
    ...
    return this.crud.createBatch('inventario', resourcePath, body, request.user?.idPersona);
  }
  ...
  updateBatch(
    ...
    return this.crud.updateBatch('inventario', resourcePath, body, request.user?.idPersona);
  }
