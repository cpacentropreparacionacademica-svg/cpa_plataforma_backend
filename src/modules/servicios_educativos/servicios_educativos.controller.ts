...
export class ServiciosEducativosController {
  ...
  createBatch(
    ...
    return this.crud.createBatch('servicios_educativos', resourcePath, body, request.user?.idPersona);
  }
  ...
  updateBatch(
    ...
    return this.crud.updateBatch('servicios_educativos', resourcePath, body, request.user?.idPersona);
  }
