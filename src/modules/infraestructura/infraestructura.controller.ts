...
@ApiCookieAuth()
@ResourceModuleName('infraestructura')
...
export class InfraestructuraController {
  ...
  validateBatchImport(
    ...
    return this.crud.validateImportBatch('infraestructura', resourcePath, { body, files });
  }
  ...
  processBatchImport(
    ...
    return this.crud.processImportBatch('infraestructura', resourcePath, { body, files }, request.user?.idPersona);
  }
  ...
  createBatch(
    ...
    return this.crud.createBatch('infraestructura', resourcePath, body, request.user?.idPersona);
  }
  ...
  updateBatch(
    ...
    return this.crud.updateBatch('infraestructura', resourcePath, body, request.user?.idPersona);
  }
  ...
  update(
    ...
    return this.crud.update('infraestructura', resourcePath, [id], body, request.user?.idPersona);
  }
  ...
  updateComposite(
    ...
    return this.crud.update('infraestructura', resourcePath, [id1, id2], body, request.user?.idPersona);
  }
